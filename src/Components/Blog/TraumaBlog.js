...
import truamaimage from "./TraumaBlog.png";



export default function TraumaBlog(){
  ...
  useEffect(() => {
    ...
    return  (
      ...
      <img src={truamaimage} alt="reading"  className="place-self-center"/>
      ...
      <img src={stories.userUrl} alt="pic1"  className="w-80 h-64 rounded-lg"/>
      <h1 className="title text-left  text-gray-500 pl-60 pr-60  font-bold pt-12 pb-3  text-4xl ">{stories.tittle}</h1>
      </div>

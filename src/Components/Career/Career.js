  ...
  return (
    <div>
      <div className="mx-auto lg:max-w-7xl px-10 py-10">
        <div className="mb-24">
          <h1 className="font-medium lg:text-6xl text-4xl">CAREERS AT HEALING</h1>
          <h1 className="text-[#424A4F] text-2xl">Be a part of making people feel better.</h1>
        </div>
        ...
        <div> 
          <h1 className="mt-16 text-[#424A4F]">What role will you play?</h1>

...
export default function About() {
  return (
    <div>
      <div>
<h1 className="px-48 pt-8 font-normal font-sans text-2xl">HEALING!</h1>

<p className="px-48 text-zinc-500 font-sans  text-s">some cool one liner!</p>
<p className=" px-48 pt-8 pb-12 font-sans  text-s break-keep">At Healing, we believe there 
...
<div className="py-2 bg-emerald-50 flex items-stretch">
<img className="w-56 ml-56 " src={finder} alt="finder" />
<div>
